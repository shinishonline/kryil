    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            maxHeight: isServicesOpen ? '400px' : '0px',
        ...
        >
          <div className="max-w-[1800px] mx-auto px-6 md:px-12 lg:px-20 py-10">
            <div className="flex gap-16">
              ...
              >
                <h3 className="font-['Lato'] text-[0.75rem] font-semibold text-black uppercase tracking-[0.15em] mb-4">
                  Our Services
                </h3>
                <p className="font-['Lato'] text-[0.95rem] text-black/50 leading-relaxed">
                  We deliver comprehensive technology solutions that transform businesses. From infrastructure to digital marketing, our expertise drives your success.
                </p>
              </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {services.map((service, index) => (
                    <Link
                      key={service.label}
                      to={service.href}
                      className="group flex items-center gap-4 p-4 rounded-xl hover:bg-black/5 transition-all duration-300"
                      style={{
                        opacity: isServicesOpen ? 1 : 0,
                        transform: isServicesOpen ? 'translateX(0)' : 'translateX(-20px)',
                        transition: `opacity 0.3s ease ${0.05 + index * 0.04}s, transform 0.3s ease ${0.05 + index * 0.04}s`,
                      }}
                    >
                      <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-black/5 text-black/40 group-hover:bg-[#dff140] group-hover:text-black transition-all duration-300">
                        {service.icon}
                      </div>
                      <div className="flex-1">
                        <span className="font-['Lato'] text-[0.95rem] font-medium text-black/70 group-hover:text-black transition-colors duration-200">
                          {service.label}
                        </span>
                      </div>
                      <svg
                        ...
                        viewBox="0 0 16 16"
                        fill="none"
                        className="text-black/20 group-hover:text-black transform group-hover:translate-x-1 transition-all duration-200"
                      >
                        <path
            ...
            <div className="mt-4 space-y-1">
              {services.map((service, index) => (
                <Link
                  key={service.label}
                  to={service.href}
                  className="flex items-center gap-4 py-3 text-white/50 hover:text-white transition-colors duration-300"
                  style={{
                    opacity: isMenuOpen ? 1 : 0,
                ...
                >
                  ...
                  <span className="font-['Lato'] text-[1rem]">
                    {service.label}
                  </span>
                </Link>
              ))}
