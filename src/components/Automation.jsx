  ...
  return (
    <div className="max-w-[1100px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
        {items.map(it => (
          <div key={it.title} className="bg-white dark:bg-slate-800 rounded-xl p-4 min-h-[140px] border border-black/10 dark:border-slate-700 transition-transform duration-200 hover:-translate-y-2 hover:shadow-card hover:border-cyan-500">
