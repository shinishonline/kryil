        ...
        <div className="flex flex-col lg:flex-row justify-between gap-16 mb-16">
          ...
          <div className="flex-shrink-0 max-w-sm" style={{ paddingLeft: '40px' }}>
            ...
            <p className="text-white/40 text-sm leading-relaxed mb-8">
              Production AI systems and data platforms, deployed inside your own infrastructure. Bangalore, India.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-12 gap-y-10">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li><Link to="/services/cybersecurity" className="text-sm text-white/50 hover:text-white transition-colors">Security Engineering</Link></li>
