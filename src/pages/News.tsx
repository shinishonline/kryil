                    ...
                    >
                      ...
                      <div className="p-6 lg:p-8">
                        <div className="flex items-center gap-3 mb-4">
                          <span className={`px-3 py-1.5 text-xs font-bold uppercase tracking-wider rounded-full border font-['Lato'] ${getTypeColor(topStories[0].type)}`}>
                            {topStories[0].type}
                          </span>
                        </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 py-1">
                          <div className="flex items-center gap-2 mb-2">
                            <span className={`px-2 py-1 text-[10px] font-bold uppercase tracking-wider rounded border font-['Lato'] ${getTypeColor(article.type)}`}>
                              {article.type}
                            </span>
                          </div>
  ...
  return (
    ...
    >
      ...
      <div className="p-6 lg:p-7">
        <div className="flex items-center gap-3 mb-4">
          <span className={`px-3 py-1.5 text-xs font-bold uppercase tracking-wider rounded-full border font-['Lato'] ${getTypeColor(article.type)}`}>
            {article.type}
          </span>
        </div>
